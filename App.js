...
const MainApp = ({navigation}) => {
    ...
    const [currentTab, setCurrentTab] = useState("Shoes");
    ...
    return (
        <SafeAreaView style={styles.container}>
          ...
          <Text style={{
            ...
            {TabButton(currentTab, setCurrentTab, "Shoes", images.home, navigation)}
            {TabButton(currentTab, setCurrentTab, "Clothes", images.search, navigation)}
            {TabButton(currentTab, setCurrentTab, "Electronics", images.bell, navigation)}
  ...
  <Animated.View style={{
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
              {currentTab === 'Shoes' && <Home />}
              {currentTab === 'Clothes' && <Clothes />}
              {currentTab === 'Electronics' && <Electronics />}
